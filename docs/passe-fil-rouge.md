# Passe de fil rouge — script v3 et écrans

Passe demandée après la répétition du 20 août : « j'ai l'impression de passer du coq à l'âne, des mots ne sont pas repris à l'écran, j'ai peur de perdre le jury ». Ce document sépare trois choses : le fil rouge tel qu'il existe déjà, les coutures faibles avec une proposition pour chacune, et l'audit des mots prononcés jamais montrés. Rien de ce qui touche au texte parlé n'est appliqué sans validation : le script v3 reste la référence.

## Le fil rouge existe, il tient en cinq phrases

La colonne vertébrale du récit est solide. Dite d'un trait :

1. Un jour de février, la Bourse a condamné non pas des résultats, mais une machine à les produire : le modèle au temps. **(Le verdict)**
2. Ce modèle, je suis allé le regarder des deux côtés de la table. **(D'où je parle · La méthode)**
3. Et j'ai trouvé un choc que personne ne facture : le temps fond, les prix ne bougent pas, le revenu disparaît. **(Le choc)**
4. Les groupes répondent en reconstruisant l'usine, jamais la facture : une usine sans caisse enregistreuse. **(L'usine)**
5. Ma thèse construit la caisse, le prix étagé, et la feuille de route la pose en vingt-quatre mois. **(La caisse · Les vingt-quatre mois · La sortie)**

L'impression de coq à l'âne ne vient pas de l'histoire, elle vient de trois défauts réparables : le récit change de vocabulaire de structure en cours de route, le bloc 4 enchaîne sept stations sans annoncer son plan, et une poignée de pivots se font sur une seule phrase. Détail ci-dessous.

## Ce que l'écran fait désormais pour le fil (déjà en place)

- **Les interludes de chapitre** : à l'ouverture de chaque bloc, son nom traverse l'écran en très grand (« 04 · Le choc ») puis se range dans le coin. Le jury voit la charpente sans que cela coûte un mot ni un clic.
...
Aucun terme interdit à l'écran dans l'état actuel : pas d'« assiette », de « périmètre », de « socle », de « benchmark ». Les quatre termes nommés (déflation latente, dette de vérification, prix étagé, unité de compte) n'apparaissent qu'après leur baptême parlé. Contrôlé écran par écran sur les captures de cette passe.
